        ...
        <>
            <section className='py-20'>
                <div className='maxW'>
                    ...
                    <h2 className='font-bold text-textPrimary text-center text-3xl lg:text-5xl'>Lorem ipsum dolor sit amet.</h2>

                    <article className='mt-10 flex flex-col justify-center gap-7 lg:flex-row'>
                    ...
                    <div className='mt-20'>
                        ...
                        <div className='flex  justify-between items-start gap-8 flex-col lg:flex-row'>
                            ...
                            <article className='border-r-4 text-right border-Verde py-4 flex-1 lg:mt-16'>
