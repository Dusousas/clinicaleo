        ...
        <section className='py-20 bg-Azul/5'>
            <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-semibold mb-4">Documentos do Tratamento</h2>
                ...
                <div className="flex justify-center mb-8">
                    <div className="bg-gray-100 p-1 rounded-lg flex">
                        <button
                            ...
                            className={`px-6 py-3 rounded-md font-medium cursor-pointer transition-colors ${
                                activeTab === 'tutorial'
                    ...
                    <div className="mb-16">
                        <div className="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    <h3 className="font-semibold text-green-900 mb-2">Fórmula Natural</h3>
                                ...
                                <div key={index} className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                                    ...
                                    <div className="grid gap-6">
                                        {categoria.ingredientes.map((ingrediente, ingIndex) => (
                                            <div key={ingIndex} className="border border-gray-100 rounded-lg p-4">
                        ...
                        {documentos.map((doc, index) => (
                            <div key={index} className="border border-gray-200 rounded-lg p-4 hover:border-teal-300 transition-colors">
                                ...
                                <div className="flex space-x-2">
                                    <button className="flex-1 flex items-center justify-center px-3 py-2 border border-gray-300 rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 transition-colors">
                                        <Eye className="w-4 h-4 mr-2" />
                                        Visualizar
                                    </button>
                                    <button className="flex-1 flex items-center justify-center px-3 py-2 bg-teal-600 text-white rounded-md text-sm font-medium hover:bg-teal-700 transition-colors">
